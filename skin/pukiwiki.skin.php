...
<?php echo $html_scripting_data ?>
  ...
  <header>
    ...
    <div class="unagilogo"><a href="/unagimeshi3/"><img src="image/logo.PNG"></a></div>
  ...
  <footer>
    ...
    $_IMAGE['skin']['edit']     = 'edit1.png';
    $_IMAGE['skin']['freeze']   = 'freeze1.png';
    $_IMAGE['skin']['unfreeze'] = 'unfreeze.png';
    $_IMAGE['skin']['diff']     = 'diff.png';
    $_IMAGE['skin']['upload']   = 'file.png';
    $_IMAGE['skin']['copy']     = 'copy.png';
    $_IMAGE['skin']['rename']   = 'rename.png';
    $_IMAGE['skin']['top']      = 'top1.png';
    $_IMAGE['skin']['list']     = 'list.png';
    $_IMAGE['skin']['search']   = 'search.png';
    $_IMAGE['skin']['recent']   = 'recentchanges.png';
    $_IMAGE['skin']['backup']   = 'backup.png';
    $_IMAGE['skin']['help']     = 'HELP1.png';
